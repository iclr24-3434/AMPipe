...
template<>
void run_mha_bwd_<cutlass::bfloat16_t, 128>(Flash_bwd_params &params, cudaStream_t stream, const int offset, const bool configure) {
    run_mha_bwd_hdim128<cutlass::bfloat16_t>(params, stream, offset, configure);
}