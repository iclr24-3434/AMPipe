...
//     });
// }
template<> void run_mha_fwd_<cutlass::bfloat16_t, 192>(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    run_mha_fwd_hdim192<cutlass::bfloat16_t>(params, offset, stream);
}
