...
//     });
// }
template<> void run_mha_fwd_<cutlass::half_t, 96>(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    run_mha_fwd_hdim96<cutlass::half_t>(params, offset, stream);
}