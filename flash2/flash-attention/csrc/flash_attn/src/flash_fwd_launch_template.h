...
__global__ void flash_fwd_kernel(Flash_fwd_params params, const int offset) {
    flash::compute_attn<Kernel_traits, Is_dropout, Is_causal, Is_even_N, Is_even_K, Return_softmax>(params, offset);
}

template<typename Kernel_traits, bool Is_dropout, bool Is_causal>
void run_flash_fwd(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    ...
    BOOL_SWITCH(is_even_N, IsEvenNConst, [&] {
        BOOL_SWITCH(is_even_K, IsEvenKConst, [&] {
            BOOL_SWITCH(return_softmax, ReturnSoftmaxConst, [&] {
                ...
                kernel<<<grid, Kernel_traits::kNThreads, smem_size, stream>>>(params, offset);
...
template<typename T>
void run_mha_fwd_hdim32(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    constexpr int Headdim = 32;
    BOOL_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        BOOL_SWITCH(params.is_causal, Is_causal, [&] {
            run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
        });
    });
}

template<typename T>
void run_mha_fwd_hdim64(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    ...
    BOOL_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        BOOL_SWITCH(params.is_causal, Is_causal, [&] {
            if constexpr(!Is_dropout) {
                ...
                run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
                // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, true, T>, Is_dropout, Is_causal>(params, stream);
                // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, false, T>, Is_dropout, Is_causal>(params, stream);
...
template<typename T>
void run_mha_fwd_hdim96(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
        ...
        BOOL_SWITCH(params.is_causal, Is_causal, [&] {
            ...
            if (is_sm8x) {
                if constexpr(!Is_causal) {
                    ...
                    run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
                }
            } else {
                run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
            }
...
template<typename T>
void run_mha_fwd_hdim128(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    ...
    BOOL_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        BOOL_SWITCH(params.is_causal, Is_causal, [&] {
            if constexpr(!Is_dropout) {
                ...
                if (is_sm8x) {
                    if constexpr(!Is_causal) {
                        run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 32, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
                    } else {
                        run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
                    }
                } else {
...
template<typename T>
void run_mha_fwd_hdim160(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
    ...
    BOOL_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        BOOL_SWITCH(params.is_causal, Is_causal, [&] {
            ...
            if (is_sm8x) {
                if constexpr(!Is_causal) {
                    run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 8, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
                } else {
                    run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T>, Is_dropout, Is_causal>(params, offset, stream);
                }
            } else {
...
template<typename T>
void run_mha_fwd_hdim192(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
...
template<typename T>
void run_mha_fwd_hdim224(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
...
template<typename T>
void run_mha_fwd_hdim256(Flash_fwd_params &params, const int offset, cudaStream_t stream) {
