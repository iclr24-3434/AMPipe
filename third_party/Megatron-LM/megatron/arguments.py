...
def _add_training_args(parser):
    ...
    group.add_argument('--fusion-attmoe', action='store_true',
                       help='enable attention moe fusion')
    group.add_argument('--ampipe', action='store_true',
                       help='enable attention moe fusion')
    group.add_argument('--pipe-degree', type=int, default=-1,
                       help='splits of sub TB pipelining')
    group.add_argument('--fusion-split', type=int, default=-1,
                       help='splits of sub pipelining')
    return parser
